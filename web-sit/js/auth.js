...
//             id: generateId(),
//             username: 'admin',
//             password: btoa('123') // '123' تصبح 'MTIz'
...
//     // *** تم التعديل: تشفير كلمة المرور المدخلة قبل المقارنة ***
//     const encodedPassword = btoa(password);

//     const foundUser = users.find(user => user.username === username && user.password === encodedPassword);
...
function initializeDefaultUser() {
    ...
    if (users.length === 0) {
        const defaultAdmin = {
            id: generateId(),
            username: 'admin',
            // *** تم التعديل: تشفير كلمة المرور الافتراضية ***
            password: btoa('123') // '123' تصبح 'MTIz'
        };
        saveToLocalStorage('users', [defaultAdmin]);
    }
...
function handleCreateNewUser(e) {
    ...
    const newUser = {
        id: generateId(),
        username: newUsername,
        // *** تم التعديل: تشفير كلمة المرور الجديدة قبل الحفظ ***
